    ...
    <>
        ...
        <section id="about" aria-labelledby="about-title">
          ...
          <div className="cards">
            <article className="card tilt">
              ...
              <div className="desc">
                Passionate about exploring cutting-edge technologies and pushing
                the limits of what's possible in web development. Always staying
                ahead of the curve with emerging trends like AI integration and
                Web3.
              </div>
            </article>
            <article className="card tilt">
              ...
              <div className="desc">
                ...
                solutions. I thrive on finding creative approaches that balance
                functionality with exceptional user experience, ensuring code is
            ...
            <article className="card tilt">
              ...
              <div className="desc">
                ...
                pixel-perfect implementations and smooth, engaging animations
        ...
        <section id="contact" aria-labelledby="contact-title">
          ...
          <div className="cards">
            <div className="card tilt">
              ...
              <form
                id="contactForm"
                action="https://formspree.io/f/xvgbjbjq"
                method="POST"
                style={{
                  display: "flex",
            ...
            <div className="card tilt">
              ...
              <div
                className="desc"
                style={{ marginBottom: 24, textAlign: "justify" }}
              >
                ✨ I’m always excited to collaborate on innovative projects that
                push boundaries and make a real impact — whether it’s building
                clever AI-powered tools, designing nifty automation systems,
                developing full-stack applications, or experimenting with quirky
                creative tech ideas. Feel free to reach out via email or connect
                on social media.
              </div>
            </div>
          </div>
      ...
      <footer>
        <div className="footer-bottom">
          <p>
            © <span id="copyright-year">2025</span> Avdesh Jadon. All Rights
            Reserved.
          </p>
