...
const anim = { initial: { opacity: 0 }, whileInView: { opacity: 1 }, transition: { duration: 0.8, ease: [0.16, 1, 0.3, 1] }, viewport: { once: true, margin: "-50px" } }
