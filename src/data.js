export const CONFIG = {
  ...
  projects: {
    neural: {
      ...
      desc: "CodeManipulate is a comprehensive, AI-powered all-in-one developer platform ...",
    ...
    crypto: {
      title: "ComixAll",
      desc: "Introducing a modern, fully responsive comic reader ...",
      tech: ["Html", "CSS", "Javascript", "API", "Node.js", "Cloudinary", "Firebase", "Admin Pannel"],
      demo: "https://avdeshjadon.github.io/ComixAll/",
      repo: "https://github.com/avdeshjadon/ComixAll"
    },
    "interactive-art": {
      title: "TouchTyping",
      desc: "TouchTyping is a minimal, fully responsive web application ...",
    ...
    "3d-config": {
      ...
      desc: "A charming and fully responsive login and signup page ...",
      tech: ["Html", "CSS", "Javascript"],
    ...
    "folio-v5": {
      ...
      desc: "A pixel-perfect clone of the Spotify homepage ...",
      tech: ["Html", "CSS"],
    ...
    ecom: {
      title: "WebIn",
      desc: "WebIn is a lightweight, draggable browser extension ...",
      tech: ["Html", "CSS", "Javascript"],
